...
public class Main {
    ...
    public static void transformarEmPretoEBrancoQuatroQuadrantes() {
        try {
            BufferedImage original = ImageIO.read(new File("Matriz/src/fontes2/Imagens4/batman.png"));
    ...
    public static void transformarEmPretoEBrancoOitoQuadrantes() {
        try {
            BufferedImage original = ImageIO.read(new File("Matriz/src/fontes2/Imagens8/folha.jpg"));
    ...
    public static void transformarEmPretoEBrancoTirasVerticais() {
        try {
            BufferedImage original = ImageIO.read(new File("Matriz/src/fontes2/ImagensVerticais/folha2.jpg"));
